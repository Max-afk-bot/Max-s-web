        ...
        <div className="space-y-6 lg:col-span-1">
          <Card className="p-6 card-shine glow vibe-neon">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm font-semibold">Programming Experience</div>
          ...
          <Card className="p-6 card-shine glow vibe-fire">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-zinc-500">Focused and premium</div>
              </div>
            </div>
            <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
              <div className="rounded-lg border border-zinc-800 bg-zinc-900/20 p-3">
                ...
                <div className="text-sm mt-1">{content.deliver_values.ui_quality}</div>
              </div>
              <div className="rounded-lg border border-zinc-800 bg-zinc-900/20 p-3">
                <div className="text-xs text-zinc-500">Mindset</div>
                <div className="text-sm mt-1">{content.deliver_values.mindset}</div>
              </div>
              <div className="rounded-lg border border-zinc-800 bg-zinc-900/20 p-3">
                <div className="text-xs text-zinc-500">Direction</div>
                <div className="text-sm mt-1">{content.deliver_values.direction}</div>
              </div>
              <div className="rounded-lg border border-zinc-800 bg-zinc-900/20 p-3">
                <div className="text-xs text-zinc-500">Experience</div>
                <div className="text-sm mt-1">{content.deliver_values.experience}</div>
              </div>
            </div>
          </Card>
        </div>
        ...
        <Card className="p-6 card-shine glow vibe-cyber lg:col-span-2">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-base font-semibold">Gaming Experience</div>
                <div className="text-xs text-zinc-500">{content.gaming_tagline}</div>
              </div>
            </div>
